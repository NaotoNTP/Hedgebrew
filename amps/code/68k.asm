	...
	include "../amps/code/routines.asm"	; include macro'd routines
	include "../amps/code/debug.asm"	; debug data blob
; ===========================================================================
; ---------------------------------------------------------------------------
...
__sfx =		SFXoff
__mus =		MusOff
	include	"_sound/sfx.asm"
	include	"_sound/music.asm"
; ===========================================================================
; ---------------------------------------------------------------------------
; Define samples
; ---------------------------------------------------------------------------
...
VoiceBankMusic:
sPatNum = 0
	include "_sound/unipatchmus.asm"; include universal Voice banks
VoiceBankSFX:
sPatNum = 0
	include "_sound/unipatchsfx.asm"; include universal Voice banks
	opt ae-				; disable automatic evens

sfxaddr	include	"_sound/sfxdata.asm"	; include all sfx
musaddr	include	"_sound/musicdata.asm"	; include all music
musend
; ===========================================================================
; ---------------------------------------------------------------------------
