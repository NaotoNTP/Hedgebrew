...
; ---------------------------------------------------------------------------------------------------------------------------------------------------------
Ani_ObjSpring:
		include	"Level/Objects/Spring/Animations.asm"
Map_ObjSpring:
		include	"Level/Objects/Spring/Mappings.asm"
ArtKosM_SpringH:
		incbin	"Level/Objects/Spring/Art - Horizontal.kosm.bin"
		even
ArtKosM_SpringV:
		incbin	"Level/Objects/Spring/Art - Vertical.kosm.bin"
		even
ArtKosM_SpringD:
		incbin	"Level/Objects/Spring/Art - Diagonal.kosm.bin"
		even
; =========================================================================================================================================================