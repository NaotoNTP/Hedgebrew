...
fstr		equ		$DF				; flag to display as string (treat as offset, insert string from that offset)
fasm		equ		$D0				; flag to display as code (treat as offset, decode from that offset)
