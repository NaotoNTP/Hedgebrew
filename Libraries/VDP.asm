...
.DoubleTransfer:
			...
			; of space) than by the method of saving AGUMENTS and calling the normal
...
; (AGUMENTS inherited from DrawSprite, minus d6, a.k.a. render flags)
; ---------------------------------------------------------------------------------------------------------------------------------------------------------
DrawSprite_Loop:
...
; (AGUMENTS inherited from DrawSprite)
; ---------------------------------------------------------------------------------------------------------------------------------------------------------
DrawSprite_FlipX:
		lsr.b	#1,d6				; Is this sprite flipped vertically?
...
; (AGUMENTS inherited from DrawSprite_BoundChk, minus d6, a.k.a. render flags)
; ---------------------------------------------------------------------------------------------------------------------------------------------------------
DrawSprBndChk_Loop:
		move.b	(a1)+,d2			; Get Y offset
		ext.w	d2				; ''
...
; (AGUMENTS inherited from DrawSprite_BoundChk)
; ---------------------------------------------------------------------------------------------------------------------------------------------------------
